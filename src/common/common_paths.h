...
#else
#ifdef _WIN32
#define EMU_DATA_DIR "Citra-Enhanced"
#elif defined(__APPLE__)
#include <TargetConditionals.h>
#if TARGET_OS_IPHONE
#define APPLE_EMU_DATA_DIR "Documents" DIR_SEP "Citra-Enhanced"
#else
#define APPLE_EMU_DATA_DIR "Library" DIR_SEP "Application Support" DIR_SEP "Citra-Enhanced"
#endif
// For compatibility with XDG paths.
#define EMU_DATA_DIR "citra-enhanced-emu"
#else
#define EMU_DATA_DIR "citra-enhanced-emu"
#endif
#endif
